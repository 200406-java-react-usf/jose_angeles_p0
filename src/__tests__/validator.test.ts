...
describe('validator', () => {
    ...
    test('should return true when isValidObject is provided valid object with no nullable props', () => {
        ...
        // Act
        let result1 = isValidObject(new Artist(1, 'Drake', 'United States', 'Rap'));
        let result2 = isValidObject(new Song(5, 'Take Care', 'Drake'));
    ...
    test('should return true when isValidObject is provided valid object with nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Artist(0, 'name', 'country', 'genre'), 'id');
        let result2 = isValidObject(new Song(0, 'name', 'artist_name'), 'id');
    ...
    test('should return false when isValidObject is provided invalid object with no nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Artist(1, '', 'body', ''));
        let result2 = isValidObject(new Song(1, '', 'password'));
    ...
    test('should return false when isValidObject is provided invalid object with some nullable prop(s)', () => {
        ...
        // Act
        let result1 = isValidObject(new Artist(1, '', 'country', ''), 'id');
        let result2 = isValidObject(new Song(1, 'name', ''), 'id');
    ...
    test('should return true when isPropertyOf is provided a known property of a given constructable type', () => {
        ...
        // Act
        let result1 = isPropertyOf('country', Artist);
        let result2 = isPropertyOf('name', Song);
    ...
    test('should return false when isPropertyOf is provided a unknown property of a given constructable type', () => {
        ...
        // Act
        let result1 = isPropertyOf('weee', Artist);
        let result2 = isPropertyOf('fakeuu', Song);
